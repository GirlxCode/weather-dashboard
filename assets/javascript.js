function createCityList(citySearchList) {
  ...
  function populateCityWeather(city, citySearchList) {
    ...
    // Stored all of the data inside of an object called "weather"
    .then(function(weather) {
        ...
        var queryURL3 =
          ...
          $.ajax({
            url: queryURL3,
            method: "GET"
            // Stored all of the  data inside of an object called "uvIndex"
            ...
            $.ajax({
              url: queryURL2,
              method: "GET"
              // Stored all of the  data inside of an object called "forecast"
    ...
    $(document).ready(function() {
      ...
      $("#search-button").on("click", function(event) {
        ...
        if (city != "") {
          //Checks to see if user types in text
